  ...
  return (
    <label className="block">
      ...
      <input
        ref={ref}
        className={cn(
          'focus-ring h-11 w-full rounded-control border border-border bg-white px-3 font-inter text-[14px] font-medium leading-5 text-ink outline-none transition placeholder:font-normal placeholder:text-slate-400 focus:border-primary-soft',
          className,
        )}
        {...props}
      />
